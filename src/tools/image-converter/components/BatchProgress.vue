<template>
  <div v-if="totalFiles > 0" class="batch-progress">
    ...
    <!-- 当前文件名 -->
    <div v-if="converting && currentFileName" class="text-caption text-medium-emphasis mb-2">
      正在转换: {{ currentFileName }}
    </div>

    <!-- 统计信息 -->
    <div v-if="completedCount + failedCount > 0" class="d-flex ga-4 text-caption">
